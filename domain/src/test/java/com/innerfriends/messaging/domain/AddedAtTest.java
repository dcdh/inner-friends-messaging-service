...
public class AddedAtTest {
    ...
    public void should_return_added_at_from_event_at() {
        assertThat(new AddedAt(new EventAt(buildZonedDateTime())).at()).isEqualTo(buildZonedDateTime());
    }

    @Test
    public void should_return_added_at_from_posted_at() {
        assertThat(new AddedAt(new PostedAt(buildZonedDateTime())).at()).isEqualTo(buildZonedDateTime());
    }
